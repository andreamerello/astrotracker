...
export PYTHONPATH=~/PyCortexMDebug
...
tmux send-keys -t "$pane_gdb" "arm-none-eabi-gdb main.elf" Enter
...
tmux send-keys -t "$pane_gdb" "svd_load /home/andrea/SVD/STM32F103xx.svd" Enter
